            ...
            <div className="mr-4 hidden md:flex w-full">
                ...
                <NavigationMenu>
                    <NavigationMenuList>
                        ...
                        <NavigationMenuItem>
                            <div className="lg:flex hidden text-white group h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium   disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
                            <a className="text-md font-semibold ml-2" href="./agensipelancongan">Agensi Pelancongan</a>
                            </div>
                        </NavigationMenuItem>
                ...
                <NavigationMenu>
                <NavigationMenuList>
                            <div className=" bg-green-300 hover:bg-green-400 duration-300 text-white group inline-flex h-7 w-max items-center justify-center rounded bg-background px-4 py-2 text-sm font-medium   disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50">
