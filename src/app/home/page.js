  ...
  return (
    ...
    <div className="px-16 ">
      ...
      <div className="">
        ...
        <card className=" w-full h-full flex justify-center items-center rounded-md hover:contrast-50 group" style={{ backgroundImage: 'url("/oilandgas.svg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className=" w-11/12 h-5/6 group-hover:border-t-2 group-hover:border-l-2 group-hover:border-r-2 group-hover:border-b-2 ">
        ...
        <card className=" w-full h-full flex justify-center items-center rounded-md hover:contrast-50 group" style={{ backgroundImage: 'url("/bukituhud.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className=" w-11/12 h-5/6 group-hover:border-t-2 group-hover:border-l-2 group-hover:border-r-2 group-hover:border-b-2 ">
            <span className="hover:animate-out duration-1000 h-full flex justify-center items-center group-hover:text-4xl group-hover:font-bold group-hover:text-black text-transparent">BUKIT UHUD</span>
          </div>
          <div className="py-52"></div>
        </card>
      </div>
        ...
        <div className="grid grid-cols-3">
          ...
          <div className="bg-slate-800 col-span-2 pt-20 px-20">
            ...
            <div className="grid space-y-3">
              <span className="text-xl font-bold">ABOUT YEG 1</span>
              <span className="font-medium">Our Priority</span>
              <span className="font-medium">Who We Are</span>
              <span className="font-medium">Gallery Activities</span>
              <span className="font-medium">Carrier</span>
              <span className="font-medium">Article</span>
            </div>
            <div className="grid space-y-3">
              <span className="text-xl font-bold">ABOUT YEG</span>
              <span className="font-medium">Our Priority</span>
              <span className="font-medium">Who We Are</span>
              <span className="font-medium">Gallery Activities</span>
              <span className="font-medium">Carrier</span>
            ...
            <div className="pt-20">
            <div className="grid space-y-3 text-white text-xs">
              <span className="text-xl font-bold">ABOUT YEG</span>
              <span className="font-medium">Our Priority</span>
              <span className="font-medium">Who We Are</span>
              <span className="font-medium">Gallery Activities</span>
